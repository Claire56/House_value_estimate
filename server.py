...
House_features = ['year_built ','stories' ,'beds' ,'full_baths ','half_baths','livable_sqft', 
'total_sqft','garage_sqft','carport_sqft']
...
def home_value():
    ...
    House_features = [year_built,stories,beds,full_baths,zipcode,half_baths,livable_sqft,
    ...
    predicted = model.predict([House_features])
